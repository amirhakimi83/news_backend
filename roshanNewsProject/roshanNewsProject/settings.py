"""
Django settings for roshanNewsProject project.
...
SECRET_KEY = 'django-insecure-*3ml#*@lc39++$m!+u8jm_k2t!v^_=5v-yi&ywd=x3iyq&r2v$'
...
ROOT_URLCONF = 'roshanNewsProject.urls'
...
WSGI_APPLICATION = 'roshanNewsProject.wsgi.application'
